...
public class AddPropertyServiceImpl {
    ...
    public static List<AddProperty> getFilteredProperties(String whereClause, int start, int limit) {
        ...
        try {
            ...
            if (whereClause != null && !whereClause.isEmpty()) {
                query = "SELECT property_id, pname, pmobile, status, type, age, dimensions, city, highlights, amenities, price, listed_date, is_highlighted, image "
    ...
    public String editProperty(String property_id, String pname, String pmobile, String status, String type, String age,
            String dimensions, String city, String highlights, String amenities,
            String price, String listed_date, String is_highlighted, 
        ...
        try {
            ...
            preparedStatement = connection.prepareStatement("UPDATE property SET pname=?, pmobile=?,status=?, type=?, age=?, dimensions=?, city=?, highlights=?, amenities=?, price=?, listed_date=?, is_highlighted=?  WHERE property_id = ?");
            ...
            if (rowCount > 0) {
                ...
                try {
                    ...
                    ps2 = con2.prepareStatement("UPDATE property_audit SET ModificationDescription=?, Lastmodifieduser=?, Lastmodifieddate=CURDATE() WHERE property_id=?");
