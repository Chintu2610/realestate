...
public class PropertyDAO {
    ...
    public List<AddProperty> getAllProperties() {
        ...
        try {
            ...
            String query = "SELECT property_id,pname,pmobile, status, type, age, dimensions, city, highlights, amenities, price, listed_date, is_highlighted FROM property";
    ...
    public List<AddProperty> getPropertiesByIds(String[] propertyIds) {
        ...
        try {
            ...
            String query = "SELECT property_id,pname,pmobile, status, type, age, dimensions, city, highlights, "
            		+ "amenities, price, listed_date, is_highlighted FROM property "
    ...
    private void setPropertyPreparedStatementValues(PreparedStatement preparedStatement, AddProperty property) throws SQLException {
    ...
    public static List<AddProperty> getPropertyBypId(String propertyId) {
        ...
        try {
            connection = DBUtil.provideConnection();
            String query = "SELECT property_id, status, type, age, dimensions, city, highlights, amenities, " +
