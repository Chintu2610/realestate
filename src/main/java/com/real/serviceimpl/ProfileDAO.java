...
import com.real.bean.AddProfile;
...
public class ProfileDAO {
    ...
    public List<AddProfile> getAllProfiles() {
        ...
        try (Connection connection = DBUtil.provideConnection();
             PreparedStatement preparedStatement = connection.prepareStatement("SELECT id, firstName, lastName, gender, address, state, country, pinCode, phoneNumber FROM profile");
    ...
    public AddProfile getProfileById(String profileId) {
        ...
        try (Connection connection = DBUtil.provideConnection();
             PreparedStatement preparedStatement = connection.prepareStatement("SELECT id, firstName, lastName, gender, address, state, country, pinCode, phoneNumber FROM profile WHERE id = ?")) {
    ...
    public boolean addProfile(AddProfile profile) {
        try (Connection connection = DBUtil.provideConnection();
             PreparedStatement preparedStatement = connection.prepareStatement("INSERT INTO profile (id, firstName, lastName, gender, address, state, country, pinCode, phoneNumber) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)")) {
    ...
    public boolean updateProfile(AddProfile profile) {
        try (Connection connection = DBUtil.provideConnection();
             PreparedStatement preparedStatement = connection.prepareStatement("UPDATE profile SET firstName = ?, lastName = ?, gender = ?, address = ?, state = ?, country = ?, pinCode = ?, phoneNumber = ? WHERE id = ?")) {
