...
public class OTPGenerator {
    ...
    public static String sendOTPEmail(String toEmail,HttpSession session) {
        ...
        String body = "Your OTP for password reset is: " + otp+" valid for 10 minutes click here to reset password now : http://localhost:2503/Hrms/EnterOtp.jsp?otp="+otp;
    ...
    private static String generateOTP(HttpSession session) {
        ...
        System.out.println("email"+email+" "+"username"+username+"otp"+otp);
